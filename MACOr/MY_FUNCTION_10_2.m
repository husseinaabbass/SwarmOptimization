...
function [y Count] = MY_FUNCTION_10_2(input_array)%%% there is a modification in how to call other function
...
y  = fn_DED_10(x); %% Change Here to Call a Different System
end
%%
